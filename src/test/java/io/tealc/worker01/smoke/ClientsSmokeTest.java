...
public class ClientsSmokeTest extends Abstract {
    ...
    private static Stream<Arguments> clientDeployments() {
        return Stream.of(
                Arguments.of(ENamespaces.CLIENTS.name, "kafka-external-producer", 3),
                Arguments.of(ENamespaces.CLIENTS.name, "kafka-external-consumer", 3),
                Arguments.of(ENamespaces.CLIENTS.name, "kafka-external-streams", 3),
